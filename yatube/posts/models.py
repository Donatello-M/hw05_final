...
class Group(models.Model):
    ...
    slug = models.SlugField(verbose_name="URL группы", unique=True,
...
class Follow(models.Model):
    ...
    author = models.ForeignKey(User, on_delete=models.CASCADE,
                               ...
                               help_text="Ваша подписка")

    class Meta:
        constraints = [
            models.UniqueConstraint(
                fields=['user', 'author'], name='name of constraint'
            )
        ]
